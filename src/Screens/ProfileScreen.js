        ...
        <li key={index}>
          <div className="d-flex align-items-center">
            ...
            <div className="content">
              <Link style={{color:'#19224d',fontWeight:'bold'}} onClick={()=>setTimeout(()=>{
                window.location.reload()
              },200)} to={`/profile/${itemListComment.taiKhoan}`}>{itemListComment.hoTen} :</Link> {itemListComment.content}{" "}
              {JSON.parse(localStorage.getItem("loginUser")).taiKhoan ===
                match.params.id ||
        ...
        >
          ...
          <div className="contentPost">
            ...
            <div className="d-flex justify-content-between mb-1">
              <div style={{cursor:'pointer'}} className="like d-flex align-items-center" onClick={()=>setListLiked(!listLiked)} >
                ...
                {itemListPost.listLike.length !== 0 && (
                  <div  onClick={() => {
                    ...
                    <div className={targetLike === itemListPost.target ? 'listLike':'d-none'}>
                      <ul>
                        {renderListLike(itemListPost.listLike)}
                      </ul> 
                    </div>
                  </div>
                )}
          ...
          <div className="left">
            <div className="d-flex  justify-content-end w-100 mb-3 settingDasboard">
              <div className="d-flex justify-content-between" style={{ width: "100%" }}>
                <p className="w-50 text-white d-flex justify-content-center align-items-center"  data-toggle="modal" data-target="#albumAnh" style={{background:'gray', padding: "15px 0"}}>Album Ảnh</p>
                <p
